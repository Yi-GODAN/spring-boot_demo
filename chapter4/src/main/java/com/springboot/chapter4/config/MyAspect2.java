...
public class MyAspect2 implements Ordered {
    ...
    @Before("pointCut()")
    public void before() {
        System.out.println("【MyAspect2】的【Before】方法");
    }

    @After("pointCut()")
    public void after() {
        System.out.println("【MyAspect2】的【After】方法");

    }

    @AfterReturning("pointCut()")
    public void afterReturning() {
        System.out.println("【MyAspect2】的【AfterReturning】方法");

    }

    @AfterThrowing("pointCut()")
    public void afterThrowing() {
        System.out.println("【MyAspect2】的【AfterThrowing】方法");
